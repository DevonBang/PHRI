...
class DashboardAdminController extends Controller
{
    ...
    public function detail_member($id)
    {
        ...
        $room = Room_Detail_Information::where('member_id', $id)->first();
        $meeting = Meeting_Room_Information::where('member_id', $id)->first();
    ...
    public function jenis()
    {
        ...
        $profile = Auth('admin')->user();
        return view(
            'dashboard.master-data.jenis-usaha.index',
            [
                'jenis' => $jenis,
                'profile' => $profile
            ]
    ...
    public function klasifikasi()
    {
        ...
        $profile = Auth('admin')->user();
        return view(
            'dashboard.master-data.klasifikasi-usaha.index',
            [
