...
class DashboardMemberController extends Controller
{
    ...
    public function storeData(Request $request)
    {
        try {
            ...
            //     'jabatan_pic'=>'nullable|max:255',
            //     'no_identitas_pic'=>'nullable|max:25',
            //     'no_hp_pic'=>'nullable|max:13',
            ...
            //     'nomor_tdup' => 'required',
            //     'nomor_siu_pariwisata' => 'nullable',
            //     'nomor_siu_perdagangan' => 'nullable',
            //     'file' => 'required|file',
            ...
            $legal->nomor_tdup = $request->nomor_tdup;
            $legal->nomor_siu_perdagangan = $request->nomor_siu_perdagangan;
            $legal->nomor_siu_pariwisata = $request->nomor_siu_pariwisata;
            ...
            $meet->nama_ruangan = $request->nama_ruangan;
            $meet->kapasitas_maksimal = $request->kapasitas_maksimal;
    ...
    public function profile()
    {
        ...
        $room = Room_Detail_Information::where('member_id', '=', auth('member')->id())->first();
        $meeting = Meeting_Room_Information::where('member_id', '=', auth('member')->id())->first();
